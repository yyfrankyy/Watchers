...
public final class WatchersTest {
  ...
  @Test
  public void bindAfterTrigger() throws Exception {
  ...
  @Test
  public void bindBeforeTrigger() throws Exception {
    DefaultWatcher test = new DefaultWatcher() {
      @Override
      public void test(boolean success) {
        assertTrue(success);
  ...
  @Test
  public void bindMultipleTimesForSameObject() throws Exception {
    DefaultWatcher test = oneTimeWatcher();
    Watchers.bind(test);
    Watchers.bind(test);
    Watchers.of(DefaultWatcher.class).test(true);
  ...
  @Test
  public void bindBeforeTriggerBehavior() throws Exception {
  ...
  @Test
  public void bindBeforeTriggerReplay() throws Exception {
  ...
  @Test
  public void runInSameThread() throws Exception {
  ...
  @Test
  public void runInDifferentThread() throws Exception {
    final Thread thread = Thread.currentThread();
    DefaultWatcher test = new DefaultWatcher() {
      @Override
      public void test(boolean success) {
